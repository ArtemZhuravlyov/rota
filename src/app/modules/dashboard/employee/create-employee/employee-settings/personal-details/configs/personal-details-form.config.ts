...
export const personalInformationFormFields: FormField[] = [
  {
    key: 'firstName',
    label: 'FIRST_NAME',
...
export const familyInformationFormFields: FormField[] = [
  {
    key: 'maritalStatus',
...
export const identityInformationFormFields: FormField[] = [
  {
    key: 'placeOfBirth',
...
export const contactInformationFormFields: FormField[] = [
  {
    key: 'email',
    label: 'EMAIL',
    componentType: ComponentTypeEnum.TEXTBOX,
