...
} from "@app/modules/dashboard/settings/settings-selection/company-settings/company-settings.component";
import {
  SettingsSelectionComponent
} from "@app/modules/dashboard/settings/settings-selection/settings-selection.component";
import {
  WorkflowSettingsComponent
} from "@app/modules/dashboard/settings/settings-selection/workflow-settings/workflow-settings.component";
import {
  PayrollSettingsComponent
} from "@app/modules/dashboard/settings/settings-selection/payroll-settings/payroll-settings.component";
import {
  TimesheetSettingsComponent
} from "@app/modules/dashboard/settings/settings-selection/timesheet-settings/timesheet-settings.component";
import {
  PayrollAccountingSettingsComponent
} from "@app/modules/dashboard/settings/settings-selection/payroll-accounting-settings/payroll-accounting-settings.component";
import {
  LeaveManagementSettingsComponent
} from "@app/modules/dashboard/settings/settings-selection/leave-management-settings/leave-management-settings.component";
import {
  TrustedDevicesSettingsComponent
} from "@app/modules/dashboard/settings/settings-selection/trusted-devices-settings/trusted-devices-settings.component";
