...
export class LeaveManagementSettingsComponent {
  protected readonly LEAVE_MANAGEMENT = TranslateKey.LEAVE_MANAGEMENT;
    ...
    settingsService
      ...
      .pipe(
        tap(res => {
          ...
          this.leaveManagementPreferences
  ...
  updateLeaveManagementPreferences(): void {
    const updatedLeaveManagementPreferences = this
      .leaveManagementPreferences
      ? {
          ...this.form.getRawValue(),
          companyId: this.leaveManagementPreferences.companyId,
        }
      : this.form.getRawValue();

    this.settingsService
      .createLeaveManagementPreference(
        this.authService.getCurrentUserId(),
        this.authService.getCompanyId(),
        updatedLeaveManagementPreferences
      )
      .subscribe();
  }
}
