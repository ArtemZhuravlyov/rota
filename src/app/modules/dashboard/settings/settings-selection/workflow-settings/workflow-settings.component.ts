...
export class WorkflowSettingsComponent {
  ...
  updateWorkflowPreferences(): void {
      const updatedWorkflowPreferences = this.workflowPreferences ? {...this.form.getRawValue(), companyId: this.workflowPreferences.companyId} : this.form.getRawValue();

      this.settingsService.createWorkflowPreference(this.authService.getCurrentUserId(), this.authService.getCompanyId(), updatedWorkflowPreferences).subscribe()
  }
