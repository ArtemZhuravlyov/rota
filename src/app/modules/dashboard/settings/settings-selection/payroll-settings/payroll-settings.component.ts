...
export class PayrollSettingsComponent {
  protected readonly PAYROLL = TranslateKey.LEAVE_MANAGEMENT;
  ...
  updatePayrollPreferences(): void {
    const updatedWorkflowPreferences = this.payrollPreferences
      ? {
          ...this.form.getRawValue(),
          companyId: this.payrollPreferences.companyId,
        }
      : this.form.getRawValue();

    this.settingsService
      .createPayrollPreference(
