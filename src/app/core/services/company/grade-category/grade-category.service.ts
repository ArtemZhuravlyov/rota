...
export class GradeCategoryService {
  ...
  createGradeCategory(form: any): Observable<any> {
    return this.http
      .post(
        `${this.env.apiUrlCompany}/grade-category/create/${this.user.userId}/${this.user.companyId}`,
        form
      )
      .pipe(catchError(err => throwError(() => new Error(err))));
  }
  ...
  deleteGradeCategory(gradeCategoryId: string): Observable<any> {
    return this.http.delete(
      `${this.env.apiUrlCompany}/grade-category/${this.user.userId}/${this.user.companyId}/${gradeCategoryId}`
    );
  }

  getGradeCategoryLevels(gradeCategoryId: string): Observable<any> {
    return this.http.get(
      `${this.env.apiUrlCompany}/grade-level/${this.user.userId}/${this.user.companyId}/levels/${gradeCategoryId}`
    );
  }
  ...
  createGradeLevel(
    ...
    return this.http.post(
      `${this.env.apiUrlCompany}/grade-level/create/${this.user.userId}/${this.user.companyId}`,
      form
    );
  }
  ...
  deleteGradeLevel(gradeLevelId: string): Observable<any> {
    return this.http.delete(
      `${this.env.apiUrlCompany}/grade-category/${this.user.userId}/${this.user.companyId}/${gradeLevelId}`
    );
  }
}
